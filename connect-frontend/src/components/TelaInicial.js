...
function TelaInicial() {
  ...
  const handleBenefitClick = (index) => {
    ...
    if (cadastroBtnRef.current) {
      cadastroBtnRef.current.scrollIntoView({
        behavior: "smooth",
        block: "center",
      });
  ...
  return (
    <div>
      <nav
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(255, 0, 0, 0.52))",
      ...
      <section
        ...
        style={{ height: "600px", backgroundColor: "#b80000" }}
      >
        {/* Imagem de fundo */}
        <img
          src="/images/banner-fatecconnect.png"
          alt="Banner FatecConnect"
          className="w-100 h-100 object-fit-cover img-banner-responsive"
          style={{
            marginTop: "15px",
            objectFit: "cover",
            position: "absolute",
        ...
        <div
          ...
          style={{ zIndex: 2 }}
        >
          <h2 className="fw-light mb-4" style={{ maxWidth: "600px" }}>
      ...
      <section className="text-center py-5">
        <h4 className="text-danger fw-bold mb-5">CADASTRE-SE E APROVEITE</h4>
        ...
        <div className="cadastro-beneficios">
          ...
          >
            ...
            <div className="texto">
              <h5>MENTORIA</h5>
              <p>
                Agende sua mentoria para
                <br />
                adequar-se ao seu dia a dia
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bolinha-container">
          <div
            className={`bolinha ${
              hoveredBenefit === 0 || activeBenefit === 0 ? "active" : ""
            }`}
          ></div>
          <div
            className={`bolinha ${
              hoveredBenefit === 1 || activeBenefit === 1 ? "active" : ""
            }`}
          ></div>
        </div>
      </section>
